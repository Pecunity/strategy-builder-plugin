...
export interface MockPythRevertingInterface extends Interface {
...
export interface MockPythReverting extends BaseContract {
  connect(runner?: ContractRunner | null): MockPythReverting;
  waitForDeployment(): Promise<this>;

  interface: MockPythRevertingInterface;
