...
export interface IDepositFeeHandlerInterface extends Interface {
  getEvent(
...
export interface IDepositFeeHandler extends BaseContract {
  connect(runner?: ContractRunner | null): IDepositFeeHandler;
  waitForDeployment(): Promise<this>;

  interface: IDepositFeeHandlerInterface;
