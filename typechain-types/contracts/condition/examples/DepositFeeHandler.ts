...
export interface DepositFeeHandlerInterface extends Interface {
  getFunction(
    nameOrSignature:
  ...
  encodeFunctionData(
    ...
    values: [BigNumberish, IDepositFeeHandler.ConditionStruct]
  ): string;
  encodeFunctionData(
...
export namespace ConditionAddedEvent {
  export type InputTuple = [
    id: BigNumberish,
    wallet: AddressLike,
    condition: IDepositFeeHandler.ConditionStruct
  ];
  export type OutputTuple = [
    id: bigint,
    wallet: string,
    condition: IDepositFeeHandler.ConditionStructOutput
  ];
  export interface OutputObject {
    id: bigint;
    wallet: string;
...
export interface DepositFeeHandler extends BaseContract {
  connect(runner?: ContractRunner | null): DepositFeeHandler;
  waitForDeployment(): Promise<this>;

  interface: DepositFeeHandlerInterface;
  ...
  addCondition: TypedContractMethod<
    [_id: BigNumberish, condition: IDepositFeeHandler.ConditionStruct],
    [void],
    "nonpayable"
  >;
  ...
  walletCondition: TypedContractMethod<
    ...
    [IDepositFeeHandler.ConditionStructOutput],
    "view"
  >;
