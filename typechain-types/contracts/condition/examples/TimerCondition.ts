...
export interface TimerConditionInterface extends Interface {
  getFunction(
    nameOrSignature:
  ...
  encodeFunctionData(
    ...
    values: [BigNumberish, ITimerCondition.ConditionStruct]
  ): string;
  encodeFunctionData(
...
export interface TimerCondition extends BaseContract {
  connect(runner?: ContractRunner | null): TimerCondition;
  waitForDeployment(): Promise<this>;

  interface: TimerConditionInterface;
  ...
  addCondition: TypedContractMethod<
    [_id: BigNumberish, _condition: ITimerCondition.ConditionStruct],
    [void],
    "nonpayable"
  >;
  ...
  startTimer: TypedContractMethod<[_id: BigNumberish], [void], "nonpayable">;
  ...
  walletCondition: TypedContractMethod<
    [_wallet: AddressLike, _id: BigNumberish],
    [ITimerCondition.ConditionStructOutput],
    "view"
  >;
