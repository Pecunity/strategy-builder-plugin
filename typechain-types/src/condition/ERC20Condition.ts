...
export interface ERC20ConditionInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface ERC20Condition extends BaseContract {
  connect(runner?: ContractRunner | null): ERC20Condition;
  waitForDeployment(): Promise<this>;

  interface: ERC20ConditionInterface;
