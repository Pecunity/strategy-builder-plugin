...
export interface HealthFactorConditionInterface extends Interface {
  getFunction(
    nameOrSignature:
  ...
  encodeFunctionData(
    ...
    values: [BigNumberish, IHealthFactorCondition.ConditionStruct]
  ): string;
  encodeFunctionData(
...
export interface HealthFactorCondition extends BaseContract {
  connect(runner?: ContractRunner | null): HealthFactorCondition;
  waitForDeployment(): Promise<this>;

  interface: HealthFactorConditionInterface;
  ...
  addCondition: TypedContractMethod<
    [_id: BigNumberish, condition: IHealthFactorCondition.ConditionStruct],
    [void],
    "nonpayable"
  >;
  ...
  walletCondition: TypedContractMethod<
    [_wallet: AddressLike, _id: BigNumberish],
    [IHealthFactorCondition.ConditionStructOutput],
    "view"
  >;
