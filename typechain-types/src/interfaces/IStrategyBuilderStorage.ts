...
export interface IStrategyBuilderStorageInterface extends Interface {
  getEvent(
...
export interface IStrategyBuilderStorage extends BaseContract {
  connect(runner?: ContractRunner | null): IStrategyBuilderStorage;
  waitForDeployment(): Promise<this>;

  interface: IStrategyBuilderStorageInterface;
