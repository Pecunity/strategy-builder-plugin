...
import type {
  IStrategyBuilderModule,
  IStrategyBuilderModuleInterface,
} from "../../../contracts/interfaces/IStrategyBuilderModule";
...
export class IStrategyBuilderModule__factory {
  static readonly abi = _abi;
  static createInterface(): IStrategyBuilderModuleInterface {
    return new Interface(_abi) as IStrategyBuilderModuleInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as IStrategyBuilderModule;
  }
}
